...
@export var country: String = "SouthAfrica"

var greenTexture = preload("res://assets/WindowCaptchaTimeBarGreen.png")
var orangeTexture = preload("res://assets/WindowCaptchaTimeBarOrange.png")
var redTexture = preload("res://assets/WindowCaptchaTimeBarRed.png")
var whiteTexture = preload("res://assets/WindowCaptchaTimeBarWhite.png")
...
func _ready() -> void:
	...
	timer.start()
	shouldBeActivated = [false,false,true,true,false,false,true,true]
	isActivated = [false,false,false,false,false,false,false,false]
